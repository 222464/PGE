...
void main() {
    ...
    sum += texture(pgeScene, vec2(coord.x - 4.0 * blurSize, coord.y)).rgb * 0.05;
    sum += texture(pgeScene, vec2(coord.x - 3.0 * blurSize, coord.y)).rgb * 0.09;
    sum += texture(pgeScene, vec2(coord.x - 2.0 * blurSize, coord.y)).rgb * 0.12;
    sum += texture(pgeScene, vec2(coord.x - blurSize, coord.y)).rgb * 0.15;
