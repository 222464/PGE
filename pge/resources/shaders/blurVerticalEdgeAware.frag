...
void main() {
    ...
    vec2 coord0 = vec2(coord.x, coord.y - 4.0 * pgeBlurSize);
    vec2 coord1 = vec2(coord.x, coord.y - 3.0 * pgeBlurSize);
    vec2 coord2 = vec2(coord.x, coord.y - 2.0 * pgeBlurSize);
    vec2 coord3 = vec2(coord.x, coord.y - pgeBlurSize);
    vec2 coord4 = vec2(coord.x, coord.y);
    vec2 coord5 = vec2(coord.x, coord.y + pgeBlurSize);
    vec2 coord6 = vec2(coord.x, coord.y + 2.0 * pgeBlurSize);
    vec2 coord7 = vec2(coord.x, coord.y + 3.0 * pgeBlurSize);
    vec2 coord8 = vec2(coord.x, coord.y + 4.0 * pgeBlurSize);
