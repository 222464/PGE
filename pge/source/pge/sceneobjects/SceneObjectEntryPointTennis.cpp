...
void SceneObjectEntryPointTennis::onAdd() {
	// Physics
	...
	prop->create("resources/models/tennisCourt.obj");
	...
	std::shared_ptr<SceneObjectTennis> tennis(new SceneObjectTennis());

	getScene()->add(tennis, false);

	tennis->create();

	tennis->_layer = 100.0f;
